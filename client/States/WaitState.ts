class WaitState extends Phaser.State {
    ...
    create() {
        ...
        this.instructions = this.game.add.text(this.game.world.centerX, this.game.world.centerY - 200, "Enter Partner's Name:",
        ...
        this.invalid = this.game.add.text(this.game.world.centerX, this.game.world.centerY + 300, "Invalid Partner Name",
